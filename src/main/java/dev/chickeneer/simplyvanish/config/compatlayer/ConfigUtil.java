...
public class ConfigUtil {
    ...
    public static final int CANARY_INT = Integer.MIN_VALUE + 7;
    public static final long CANARY_LONG = Long.MIN_VALUE + 7L;
    public static final double CANARY_DOUBLE = -Double.MAX_VALUE + 1.125798;
